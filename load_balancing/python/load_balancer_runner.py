...
class LBRunner:
    ...
    def main():
        ...
        parser.add_argument("--benchmark", type=str, required=True, help="Which benchmark to run ", choices=["base", "split", "heuristic"])
    ...
    def zipfian_benchmark():
        ...
        for round_num in range(LBRunner.num_rounds):
            ...
            for server_num, Rs in enumerate(return_r):
                ...
                # Quick checks
                assert server_load <= average_load * 1.1
                assert server_load >= average_load * 0.9
